...
nvidia-smi
python3 stac-mjx/process_snips.py paths.xml="././models/rodent_stac_optimized.xml" paths.fit_path="fit_snips.p" paths.transform_path="transform_snips.p" stac.sampler="random" stac.n_fit_frames=1000
"""
